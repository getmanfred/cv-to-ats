    ...
    <div className="min-h-screen bg-bg-light">
      ...
      <section className="bg-navy text-white py-16 px-6">
        <div className="max-w-container mx-auto text-center">
          ...
          <h1 className="font-display font-[900] text-4xl md:text-5xl leading-tight mb-4">
      ...
      <section className="bg-navy py-16 px-6">
        <div className="max-w-4xl mx-auto">
          <div className="mb-12">
            ...
            <h2 className="font-display font-[900] text-white leading-tight" style={{ fontSize: '2.8rem' }}>
              Tres pasos,
              <br />
        ...
        <div className="max-w-4xl mx-auto">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-4">
            <div>
              ...
              <h2 className="font-display font-[900] leading-tight text-navy" style={{ fontSize: '2.8rem' }}>
                Qué analiza
                <br />
